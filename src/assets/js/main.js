        ...
        var retina = window.devicePixelRatio > 1 ? true : false;
          if(retina) {
            if(!$('body').hasClass('is_dark')) {
                $('#site-logo').find('img').attr( {src:'assets/images/logo/logo.png',width:'151',height:'45'} );
              }
              else {
                $('#site-logo').find('img').attr( {src:'assets/images/logo/logo.png',width:'151',height:'45'} );
                $('#logo-footer').find('img').attr( {src:'assets/images/logo/logo.png',width:'151',height:'45'} );
              }
          }
      };
